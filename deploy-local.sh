...
HOSTNAME='opencrvs.local' VERSION='latest' PAPERTRAIL='$PAPERTRAIL' docker stack deploy -c stack-infrastructure.yml -c docker-compose.yml --with-registry-auth infrastructure
